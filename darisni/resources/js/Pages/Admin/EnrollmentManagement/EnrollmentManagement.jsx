...
export default function EnrollmentManagement({ users, courses = [] }) {
    ...
    const handleEnroll = async (courseIds) => {
        ...
        setLoading(true);
        router.post(route('admin.enrollments.store'), {
                ...
                <div className={styles.container}>
                    <div className={styles.header}>
                        <div className={styles.headerContent}>
                            <div>
                                <h1 className={styles.title}>Enrollment Management</h1>
                                <p className={styles.subtitle}>View and manage user course enrollments</p>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <tr key={user.id} className={styles.userRow}>
                                        ...
                                        <td>
                                            {user.enrollments.length > 0 ? (           
                                                ...
                                                <span className={styles.noImagePreview}>No courses</span>
                                            )}
                                        </td>
                                        <td>
            ...
            <div className={styles.modal} onClick={e => e.stopPropagation()}>
                ...
                <form onSubmit={handleSubmit} className={styles.modalForm}>
                    ...
                    <div className={styles.modalActions}>
                        ...
                        <button type="submit" disabled={loading || selectedCourses.length === 0} className={styles.saveBtn}>
                    ...
                    {user.enrollments.length === 0 ? (
                        ...
                        <ul style={{ padding: 0, margin: 0 }}>
                            {user.enrollments.map(e => (
                                <li key={e.id} style={{ display: 'flex', alignItems: 'center', marginBottom: 12 }}>
                                    <span className={styles.courseCode}>{e.course?.code}</span>
                                    <span style={{ flex: 1 }}>{e.course?.title}</span>
                                    <button
