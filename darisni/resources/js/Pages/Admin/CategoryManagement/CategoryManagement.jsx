...
export default function CategoryManagement({ categories: initialCategories, stats: initialStats }) {
                ...
                <div className={styles.container}>
                    <div className={styles.header}>
                        <div className={styles.headerContent}>
                            <div>
                                ...
                                <p className={styles.subtitle}>Manage course categories for your platform</p>
                            </div>
                            <button 
                    ...
                    <div className={styles.statsContainer}>
                        <div className={styles.statItem}>
                            <span className={styles.statNumber}>{filteredCategories.length}</span>
                            <span className={styles.statLabel}>Total Categories</span>
                        </div>
                        <div className={styles.statItem}>
                            <span className={styles.statNumber}>
                                {filteredCategories.reduce((total, cat) => total + (cat.courses_count || 0), 0)}
                            </span>
                            <span className={styles.statLabel}>Total Courses</span>
                        </div>
                        <div className={styles.statItem}>
                            <span className={styles.statNumber}>
                                {filteredCategories.filter(cat => cat.courses_count > 0).length}
                            </span>
                            <span className={styles.statLabel}>Active Categories</span>
                        </div>
                        <div className={styles.statItem}>
                            <span className={styles.statNumber}>
                                {filteredCategories.filter(cat => !cat.courses_count).length}
                            </span>
                            <span className={styles.statLabel}>Empty Categories</span>
                        </div>
                    </div>
                ...
                {mode === 'view' ? (
                    <div className={styles.categoryDetailsView}>
                        <div className={styles.categoryImageSection}>
                            {category.image ? (
                                <img src={category.image} alt={category.name} className={styles.categoryImageLarge} />
                            ) : (
            ...
            <div className={styles.deleteModal} onClick={e => e.stopPropagation()}>
                ...
                <div className={styles.deleteModalContent}>
                    ...
                    <div className={styles.categoryPreview}>
                        ...
                        <span>{category.description || 'No description'}</span><br />
                        <span>Courses: {category.courses_count || 0}</span>
                    </div>
                    <p className={styles.warning}>This action cannot be undone and will affect associated courses.</p>
                </div>
